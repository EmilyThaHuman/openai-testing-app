...
import { toolRegistry } from '@/components/open-canvas/ToolRegistry'
import { 
  Search,
  Book,
  Code,
    ...
    >
      <motion.div variants={itemVariants}>
        ...
        <p className="text-muted-foreground">
          OpenCanvas is a powerful development environment that combines AI assistance
          with a rich set of tools for web development, data analysis, and more.
        </p>
      </motion.div>
          ...
          {[
            {
              ...
              description: 'Write and execute code with real-time AI assistance'
            },
            {
              icon: MessageSquare,
