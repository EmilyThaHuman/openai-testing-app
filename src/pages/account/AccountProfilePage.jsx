...
import { User, Mail, Phone, MapPin, Camera, Shield, Globe, Briefcase } from 'lucide-react'
    ...
    <AccountPageLayout title="Profile Settings">
      ...
      >
        ...
        <HoverCard className="p-8">
          <motion.div variants={cardVariants} className="flex items-center gap-8">
            <div className="relative group">
          ...
          <HoverCard className="p-8">
            <form className="space-y-8">
              ...
              <div className="space-y-6">
                <motion.div variants={listItemVariants} className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <motion.div variants={listItemVariants} className="space-y-2">
                    ...
                    <InputWithIcon icon={User} id="name" defaultValue={user?.name} />
                  </motion.div>

                  <motion.div variants={listItemVariants} className="space-y-2">
                    <Label htmlFor="email">Email Address</Label>
                    <InputWithIcon icon={Mail} id="email" defaultValue={user?.email} />
                  </motion.div>

                  <motion.div variants={listItemVariants} className="space-y-2">
                    <Label htmlFor="phone">Phone Number</Label>
                    <InputWithIcon icon={Phone} id="phone" defaultValue={user?.phone} />
                  </motion.div>

                  <motion.div variants={listItemVariants} className="space-y-2">
                    <Label htmlFor="location">Location</Label>
                    <InputWithIcon icon={MapPin} id="location" defaultValue={user?.location} />
                  </motion.div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <motion.div variants={listItemVariants} className="space-y-2">
                    ...
                    <InputWithIcon icon={Briefcase} id="company" defaultValue={user?.company} />
                  </motion.div>

                  <motion.div variants={listItemVariants} className="space-y-2">
                    <Label htmlFor="role">Role</Label>
                    <InputWithIcon icon={Shield} id="role" defaultValue={user?.role} />
                  </motion.div>
                </div>
              </div>
