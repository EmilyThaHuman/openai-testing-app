...
export async function googleSearch(
  ...
  const url = `https://www.googleapis.com/customsearch/v1?key=${import.meta.env.GOOGLE_SEARCH_API_KEY}&cx=${import.meta.env.GOOGLE_CX}&q=${encodeURIComponent(message)}&num=${numberOfPagesToScan}`;
...
export async function serperSearch(
  ...
  const options = {
    method: 'POST',
    headers: {
      'X-API-KEY': import.meta.env.SERPER_API,
